...
class juPage{
    ...
    view({model, dispatch}){        
        ...
        const info= h('div.page-size',[
                    h('span', 'Page Size'),
                    h('select.form-control.form-control-'+model.elmSize,{props:{value:this.model.pageSize}, on:{change:(e)=>this._changePageSize(e.target.value)}},[
        ...
        if(model.search){elms.push(h('div.col-12.col-md-auto',[h('input.search.form-control.form-control-'+model.elmSize,
            {on:{keyup:ev=>this.search(ev.target.value)},props:{type:'text',value:this.searchText, placeholder:'Search...'}})]));}      
